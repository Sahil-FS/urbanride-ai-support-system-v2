...
INTENT_RESPONSES: dict[str, list[str]] = {
    ...
    # Ride tracking
    "track_ride": [
        "I can help you with your ride status. "
        "What seems to be the issue with your driver?",
    ],
    "driver_not_arrived": [
    ...
    "driver_late": [
        ...
        "Please check the live map for their exact location and estimated arrival time. "
        "If the wait is too long you can cancel without any charge.",
    ],
    "cannot_contact_driver": [
        "Try calling your driver from the app ride screen. "
        "If there is still no response after 2 minutes, please select an option below:",
    ],
    "wrong_pickup_location": [
    ...
    "cancel_by_driver": [
        ...
        "A new driver will be assigned to you automatically within 2 minutes. "
...
def get_response(intent: str, confidence: float, original_text: str = "") -> dict:
    """
    Decision tree:
